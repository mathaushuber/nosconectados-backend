...
/**
  * Esta rota é usada para obter os dados do usuário após login.
  *
  * @param Request $request O objeto de solicitação.
  * @param Response $response O objeto de resposta.
  * @return Response O objeto de resposta com os dados do usuário.
  */
...
/**
  * Esta rota é usada para obter os dados do sensor.
  *
  * @param Request $request O objeto de solicitação.
  * @param Response $response O objeto de resposta.
  * @return Response O objeto de resposta com os dados do sensor.
  */
...
/**
  * Esta rota é usada para obter o token.
  *
  * @param Request $request O objeto de solicitação.
  * @param Response $response O objeto de resposta.
  * @return Response O objeto de resposta com o token.
  */
...
/**
  * Esta rota é utilizada para gerar um token para o usuário acessar a API.
  *
  * @param Request $request O objeto de solicitação.
  * @param Response $response O objeto de resposta.
  * @return Response O objeto de resposta com o token gerado.
  */
